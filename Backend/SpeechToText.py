...
# Function to modify a query to ensure proper puntating and formatting.
def QueryModifier(Query):
    new_query = Query.lower().strip()
    query_words = new_query.split()
    question_words = ["how" , "what" , "where" , "when" , "why" , "who" , "which" , "whom" , "whose" , "how's" , "what's" , "where's" , "when's" , "why's" , "who's" , "which's" , "whom's" , "whose's" , "can you"]
